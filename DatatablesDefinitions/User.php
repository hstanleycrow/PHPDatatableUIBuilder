<?php
// ConfigUser.php
namespace hstanleycrow\DatatablesDefinitions;
...
class User
{
    ...
    public function getButtons(): array
    {
        return [
            [
                ...
                'path' => 'editar',
                'buttonText' => 'Editar',
                #'buttonClass' => \hstanleycrow\Components\Buttons\EditButton::class,
            ...
            [
                ...
                'path' => 'borrar',
                'buttonText' => 'Borrar',
                #'buttonClass' => \hstanleycrow\Components\Buttons\DeleteButton::class,
    ...
    {
        return "FROM `users` AS `a` INNER JOIN `user_status` AS `b` ON (`a`.`status_id` = `b`.`id`)";
    }
